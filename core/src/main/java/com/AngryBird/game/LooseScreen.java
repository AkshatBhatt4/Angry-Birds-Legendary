...
public class LooseScreen {
    ...
    public void render(SpriteBatch batch) {
        ...
        batch.draw(nostar1, nostar1Bounds.x, nostar1Bounds.y, nostar1Bounds.width, nostar1Bounds.height);
        batch.draw(nostar1, nostar2Bounds.x, nostar2Bounds.y, nostar2Bounds.width, nostar2Bounds.height);
        batch.draw(nostar1, nostar3Bounds.x, nostar3Bounds.y, nostar3Bounds.width, nostar3Bounds.height);
        batch.draw(gover, goverBounds.x, goverBounds.y, goverBounds.width, goverBounds.height);
        batch.draw(backButton, backButtonBounds.x, backButtonBounds.y, backButtonBounds.width, backButtonBounds.height);
        batch.draw(replayButton, replayButtonBounds.x, replayButtonBounds.y, replayButtonBounds.width, replayButtonBounds.height);
    }
